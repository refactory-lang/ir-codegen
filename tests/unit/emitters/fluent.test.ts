...
describe('emitFluent', () => {
  it('should emit ir namespace for rust', () => {
    ...
    expect(source).toContain("import { struct_ } from './nodes/struct.ts'");
    expect(source).toContain("import { fn } from './nodes/function.ts'");
    expect(source).toContain("import { use_ } from './nodes/use.ts'");
